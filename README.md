...
- **Enquete virou uma aba própria, igual aos recados**: a opção de criar enquete **saiu de dentro do chat da turma**. Agora, na nova aba **"Enquetes"**, Professora Regente, Professora Auxiliar, Estagiária e qualquer pessoa da Direção criam uma pergunta com até 8 opções e escolhem enviar para **todo mundo** ou só para **uma turma específica** — exatamente como um recado. A enquete aparece em tela cheia assim que a pessoa abre o app (depois de qualquer recado pendente ser confirmado primeiro) e só some depois que ela **vota** (o voto vale como a confirmação; não dá pra trocar o voto depois). Quem criou acompanha, em tempo real, quantos votos cada opção tem, o nome de quem votou em cada uma, e quem ainda falta votar — nada de voto anônimo aqui. Enquetes antigas que já estavam em algum chat de turma continuam aparecendo e recebendo voto normalmente até sumirem sozinhas na limpeza automática de 5 dias.
